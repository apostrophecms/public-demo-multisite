    ...
    <div className="mode-switch" data-mode-switch>
      <label htmlFor="light-dark-toggle">
        ...
        <div className="toggle-slot">
          ...
          <div className="moon-icon-wrapper" dangerouslySetInnerHTML={{
